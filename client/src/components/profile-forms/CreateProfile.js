...
const CreateProfile = ({ createProfile, history }) => {
  ...
  return (
    <Fragment>
      ...
      <p className="lead">
        <i className="fas fa-user m-1"></i>let's get some information to make
        your profile stand up
      </p>
...
export default connect(null, { createProfile })(withRouter(CreateProfile)); //https://reactrouter.com/core/api/withRouter
